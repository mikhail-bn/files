    ...
    function script_showMore() {
        ...
        function showMoreActions(e) {
            ...
            if (targetElement.closest("[data-showmore-button]")) {
                ...
                if (showMoreBlock.classList.contains("_show-more")) showMoreContent.style.height = `${showMoreHiddenHeight}px`; else showMoreContent.style.height = `${showMoreOriginalHeight}px`;
        ...
        function getHiddenHeight(showMoreBlock) {
            ...
            let hiddenHeight = 0;
            if (!showMoreType) showMoreType = `text`;
            if (!showMoreSize) if (!showMoreType) showMoreSize = `150`; else showMoreSize = `3`;
            if ("text" === showMoreType) hiddenHeight = showMoreSize;
            return hiddenHeight;
        }
        function getOriginalHeight(showMoreBlock) {
            ...
            if (showMoreContentChildren.length) showMoreContentChildren.forEach((showMoreContentChild => {
